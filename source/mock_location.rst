...
Как использовать стороннее приложение в качестве источника координат для текущего местоположения устройства. Использование внешние источника координат - часто возникающая задача, когда вам нужно подключить внешнюю GPS/GLONASS антенну или другое устройство улучшающее прием координат.

Это инструкция описывает одну из возможных конфигураций. У вас может быть другие приложения и настройки, но схема подключения остается та же.
...
Установите приложение для подмены координаты. Например, `такое <https://lockito-app.com/>`_.
