...
.. figure:: _static/ngmobile_measure.png
   ...
   Цифрами обозначены: 1 - панель дерева слоев; 2 - измеренное расстояние; 3 – кнопка «Показать текущее местоположение»; 4 - кнопка «Загрузить/обновить геоданные»; 5 - кнопка вызова контекстного меню; 6 - изменение масштаба карты; 7 - выйти из режима измерения расстояния.
