...
6. показать выделенный объект на карте (Если ваши объекты расположены плотно, сначала приблизьте карту так, чтобы на экран помещалось только несколько объектов, затем выберите нужный в таблице и нажмите на лупу. Карта будет перемещена к объекту с сохранением выбранного зума); 
