...
При долгом удержании пальца не геометрии векторного слоя окно карты переходит в режим выбора действия (см. :numref:`selectmode_pic`). 
...
В зависимости от размера экрана окно настроек может быть однопанельной и двупанельной. Окно настроек представлено на :numref:`settings_pic` (однопанельный режим). 
