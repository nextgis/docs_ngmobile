...
В нижней части экрана может размещаться панель статуса (если включена соответствующая 
опция: Настройки - Карта - Показать панель статуса) :numref:`ngmobile_status_bar_pic`.

.. figure:: _static/ngmobile_status_bar.png
   :name: ngmobile_status_bar_pic
   :align: center
   :height: 10cm
...
В зависимости от размера экрана панель может занимать одну или две строки :numref:`ngmobile_Information_bar_pic`.

.. figure:: _static/ngmobile_Information_bar.png
   :name: ngmobile_Information_bar_pic
   :align: center
   :height: 10cm

   Информация на Панели статуса.
