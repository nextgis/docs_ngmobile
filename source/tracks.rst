...
Чтобы воспользоваться функцией записи трека, необходимо разрешить приложению **доступ к местоположению** устройства в настройках устройства (:menuselection:`Настройки -> Конфиденциальность -> Местоположение`).
...
Для того чтобы завершить запись трека, нажмите **Стоп** либо в панели уведомлений операционной системы (см. :numref:`ngmobile_new_gpx_layer_1_pic`, п.4), либо в меню в главном окне приложения:
...
После завершения записи трека им можно управлять, в том числе экспортировать его в формат GPX. Как это сделать, описано в разделе :ref:`ngmobile_export_GPX`. Также треки можно `отображать на веб-карте <https://docs.nextgis.ru/docs_ngcom/source/tracking.html#tracking-create>`_.
...
.. figure:: _static/track_selected_ru.png
   ...
   Цифрами обозначено: 1 - назад; 2 - количество выбранных треков; 3 – настройки цвета выбранных треков; 4 - экспорт; 5 - меню действий с треками; 6 - выбор трека; 7 - видимость трека; 8 - цвет трека.

С помощью этого меню вы можете:

* настроить цвет выделенного трека или нескольких треков;
* поделиться треками;
* включить/выключить видимость треков, нажав на |ic_eye|.

При нажатии на три точки в правом верхнем углу откроется контекстное меню управления треками.

.. figure:: _static/track_list_menu_ru.png
...
* Удалить выделенные треке (**! невозможно отменить**).
