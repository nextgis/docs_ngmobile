...
Перейти к добавлению геометрии обходом можно из режима просмотра карты и из режима редактирования слоя.

Нажмите на большую кнопку с плюсом в нижнем углу и среди появившихся круглых кнопок выберите команду |ic_walk| "Добавить геометрию обходом". 

Это откроет список всех редактируемых слоев с линейной/мультилинейной и полигональной/мультиполигональной геометрией в виде отдельного диалога (см. :numref:`ngmobile_selectlayer1_pic`).
...
Выберите слой, в который нужно добавить обходом новый объект. Этот слой откроется в режиме Записи обходом (см. :numref:`ngmobile_new_gpx_vector_1`), и NextGIS Mobile начнет запись новой геометрии в векторный слой.
