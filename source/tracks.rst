...
Чтобы воспользоваться функцией записи трека, необходимо разрешить приложению **доступ к местоположению** устройства в настройках устройства (:menuselect:`Настройки -> Конфиденциальность -> Местоположение`).
