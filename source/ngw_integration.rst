...
2. Далее выбрать пункт меню "Добавить слой".
3. В открывшемся меню опций необходимо выбрать пункт "NGW" (см. :numref:`ngmobile_add_ngw_layer_pic`). 
4. В открывшемся окне выбрать ранее созданную учетную запись (см. :numref:`ngmobile_select_ngw_layer_pic`).
5. В открывшемся окне находится список внутренних папок и файлов выбранной учетной 
   записи NextGIS Web (см. :numref:`ngmobile_list_of_files_pic`).
