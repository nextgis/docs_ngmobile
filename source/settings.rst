...
.. admonition:: Как открыть
   ...
   |ic_menu| :menuselect:`Настройки --> Карта`

Блок настроек "Общие" позволяет изменять основные настройки приложения:
...
Чтобы восстановить такой слой, зайдите в :menuselect:`Настройки -> Карта` и нажмите **Восстановить потерянные слои**.
...
.. admonition:: Как открыть
   ...
   |ic_menu| :menuselect:`Настройки --> Местоположение`
...
.. admonition:: Как открыть
   ...
   |ic_menu| :menuselect:`Настройки --> Мои треки`
