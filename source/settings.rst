...
В некоторых редких ситуация, таких как сбой памяти, аварийное завершение при записи и т.п. возможна рассинхронизация списка слоёв на карте в приложении и памяти.
