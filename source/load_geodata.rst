...
NextGIS Mobile позволяет загружать геоданные из :ref:`Веб ГИС, созданной на облачном сервере nextgis.com <ngcom_create>`.

.. only:: html

   Для осуществления загрузки геоданых из Веб ГИС необходимо выполнить вход в Веб ГИС с 
