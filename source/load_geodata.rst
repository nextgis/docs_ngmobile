...
Файл формата GeoJSON имеет расширение .geojson. Файл формата GeoJSON также может 
находиться внутри архива с расширением .geojson.zip, при этом файл должен быть в 
корне этого архива, а не находиться в подпапках архива. 
...
Подробнее о редактировании файла формата GeoJSON описано в разделе :ref:`ngmobile_editing`.
