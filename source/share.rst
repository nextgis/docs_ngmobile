...
При выборе пункта контекстного меню "экспорт слоя" откроется стандартное системное 
...
При выборе одного из предложенных вариантов, данные из слоя записываются в формат :term:`GeoJSON` (:term:`система координат` Web Mercator, EPSG:3857). Файлу присваивается такое же 
название, что и имя слоя.
