...
**NextGIS Mobile** - это мобильная :term:`геоинформационная система` (:abbr:`ГИС (геоинформационная система)`) для операционной системы Android.

.. raw:: html

   <iframe width="720" height="405" src="https://rutube.ru/play/embed/fa43078a2be7dfefce20331ced654802/" style="border: none;" allow="clipboard-write; autoplay" allowFullScreen></iframe>

Посмотреть видео на `RuTube <https://rutube.ru/video/fa43078a2be7dfefce20331ced654802/>`_, `YouTube <https://youtu.be/aRQfGKGPj1E?si=k_zLOi0l58KnOYvz>`_.
...
* накапливать и передавать в фоновом режиме по сети Интернет (при наличии подключения) в `nextgis.com <https://my.nextgis.com/signup/?next=/webgis/>`_ или `NextGIS Web <http://nextgis.ru/nextgis-web/>`_ созданные и/или измененные геоданные из векторных слоев.
