...
2. Второй способ: долгим нажатием на геометрию на экране вызвать режим выбора 
(см. :numref:`ngmobile_selectmode_pic`) и в нижней панели инструментов активировать 
команду "Редактировать".
3. Третий способ: открыть список слоёв и в меню соответствующего векторного слоя выбрать "Редактировать".


Панель инструментов редактирования
----------------------------------

После перехода в режим редактирования с помощью любого из способов, описанных в разделе Переход в режим редактирования в нижней части экрана откроется панель инструментов.
...
Для создания нового объекта нужно выбрать слой, на которой планируется его добавить. Затем следует перейти в режим редактирования, используя один из методов, описанных в разделе Переход в режим редактирования. 

Когда панель инструментов редактирования откроется, следует нажать на кнопку "Добавить новый объект". 

.. note::
   Тип геометрии нового объекта должен соответствовать типу геометрии слоя, на который планируется его добавить (например, новую точку можно добавить только на векторный слой с геометрией - точка, новую линию - на векторный слой с геометрией - линия, и т.д.).
...
типом геометрии - точка/мультиточка (см. :numref:`ngmobile_select_layer_dialogtch_pic`). Затем перейти в режим редактирования с помощью одного из методов, описанных в разделе "Переход в режим редактирования".

2. На панели инструментов редактирования необходимо нажать на кнопку "Добавить новый объект". 

3. Для добавления точки необходимо выбрать на нижней панели инструментов кнопку под 
...
4. Для добавления мультиточки в векторный слой необходимо перейти в режим редактирования
...
5. При добавлении новой точки/мультиточки в нижней панели инструментов кнопка 1 изменит 
изображение с "галочки" на "дискету". При нажатии на эту кнопку произойдет 
сохранение созданной точки/мультиточки и откроется форма ввода атрибутов 
