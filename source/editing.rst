...
.. todo: описать как попасть в режим редактирования
...
* Флажок;
* Радио-кнопка 1, Радио-кнопка 2 и т.д;
* Пикер даты;
* Фотографии.
 
Поле ввода информации "Текст" служит для пояснения вводимой информации о созданной геометрии.
Поле ввода "Пробел" необходимо для увеличения интервала между словами/предложениями 
в тексте пояснения в поле "Текст" (см. :numref:`ngmobile_text_probel_pic`). 
