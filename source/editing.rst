...
Для добавления точки в слой с **мультиточечной геометрией** после добавления первой точки нажмите "Добавить точку" |ic_multipoints|. Новую точку также можно перемещать при помощи стрелки-курсора |ic_action_anchor|.
...
Для добавления линии в слой с **мультилинейной** геометрией после добавленя первой линии нажмите "Добавить линию" |ic_multiline|. После этого можно задать положение вершин новой линии.
...
Для добавления полигона в **мультиполигональный** слой создайте первый полигон, затем нажмите кнопку "Добавить полигон" |ic_multipolygons|. После этого можно задать геометрию нового полигона.
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Перейдите в режим редактирования и выделите нужную точку.

Чтобы изменить положение точки, зажмите стрелку |ic_action_anchor| и перетащите её на новое место. 

Также вы можете с помощи панели инструментов:
...
* добавить новую точку к мультиточке (см. :numref:`ngmobile_creating_multipoint3_pic`, п.6), 
* удалить выбранную точку из мультиточки (см. :numref:`ngmobile_creating_multipoint3_pic`, п.7), 
* переместить выбранную точку мультиточечного объекта в любое новое положение (потянув за стрелку |ic_action_anchor| возле неё) или в центр экрана |ic_move_to_center|, или в текущее местоположение |ic_move_to_loc|. 
...
После этого объект изменит свой цвет на **красный**, рядом с одной из вершин объекта будет отображена стрелка |ic_action_anchor|. 

Для того чтобы изменить положение выбранной вершины линии, зажмите стрелку и перетащите её на новое место. 

Кроме того, вершину можно переместить:
...
* добавить новую линию к мультилинии (см. :numref:`ngmobile_edit_multilines_pic`, п.6), 
* удалить выбранную вершину или линию (см. :numref:`ngmobile_edit_multilines_pic`, п.7 и п.8), 
...
Для того чтобы изменить положение выбранной вершины полигона, зажмите стрелку и перетащите её на новое место. 
...
В полигоне можно создавать внутренние кольца, нажав на кнопку "Добавить внутреннее кольцо" |ic_hole|  и отредактировав геометрию кольца так же, как это было описано для геометрии полигона.
...
* добавить новый полигон к мультиполигону (см. :numref:`ngmobile_edit_multipolygon_pic`, п.6), 
* добавить/удалить внутреннее кольцо (см. :numref:`ngmobile_edit_multipolygon_pic`, п.8 и п.9), 
* удалить выбранную вершину или полигон (см. :numref:`ngmobile_edit_multipolygon_pic`, п.7 и п.10), 
* переместить вершину в любое новое положение (потянув за стрелку возле неё |ic_action_anchor|), в центр экрана |ic_move_to_center| или в своё текущее местоположение |ic_move_to_loc|.
