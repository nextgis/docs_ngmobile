...
.. figure:: _static/ngmobile_creating_multipoint2.png
   ...
   4 - сохранение изменений.
   Слева направо в нижней панели инструментов иконками обозначено: 
   1 - переместить мультиточку в центр экрана; 
   2 - переместить мультиточку в текущее местоположение.
...
Текущая точка подсвечена красным цветом, рядом с точкой отображена стрелка (см. :numref:`ngmobile_edit_mode2_pic`). 

.. figure:: _static/ngmobile_edit_mode2.png
   :name: ngmobile_edit_mode2_pic
   :align: center
   :height: 11cm  
