...
.. figure:: _static/ngmobile_tool_point_edit_panel.png
   ...
   Слева направо иконками обозначено: 1 - завершение режима; 2 - добавить новую точку; 
   3 - изменить выделенное; 4 - удаление точки; 7 - атрибуты слоя.
...
.. figure:: _static/ngmobile_edit_mode_dot.png
   ...
   Слева направо в верхней панели инструментов иконками обозначено: 
