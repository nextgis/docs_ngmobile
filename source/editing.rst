...
Существует несколько способов попасть в режим редактирования. 

Первый способ - открыть список слоёв и в меню соответствующего векторного слоя выбрать "Редактировать".

Второй способ - нажать на основную кнопка приложения (большая синяя кнопка в правом нижнем углу или 
основная кнопка приложения (т.н. FAB). При нажатии на кнопку открывается меню наиболее 
