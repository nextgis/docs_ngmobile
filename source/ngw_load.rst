...
2. Откройте дерево слоёв, нажав на три полоски |ic_layer_tree| в левом верхнем углу. 

3. Нажмите кнопку "Добавить геоданные" |button_add_layer|. В открывшемся меню выберите пункт "Открыть по ссылке".
...
1. Откройте дерево слоёв, нажав на три полоски |ic_layer_tree| в левом верхнем углу. 

2. Нажмите кнопку "Добавить геоданные" |button_add_layer|.

3. В открывшемся меню выберите пункт "Добавить из Веб ГИС" (см. :numref:`ngm_layer_tree_add_from_wg_pic`) 
