...
Тайловый кэш позволяет отображать слой даже при отсутствии подключения к интернету.
...
В этом блоке настроек можно также очистить кэш слоя.

Посмотрите, как настроить кэш растрового слоя, в видео:
